...
private:
	...
	float cal_area(const glm::ivec2& p1, const glm::ivec2& p2, const glm::ivec2& p3);
	void DrawTriangle(const glm::ivec3& p1, const glm::ivec3& p2, const glm::ivec3& p3, const glm::vec3& color);
